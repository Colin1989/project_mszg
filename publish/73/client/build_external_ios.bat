...
::第6步:同步到download目录
xcopy FileList\* D:\work\wow\73wow\download\wow_ios\debug /e/y
svn add --force D:\work\wow\73wow\download\wow_ios\debug\*.*
svn commit -m "auto generate 73 resource by script" D:\work\wow\73wow\download\wow_ios\debug\*.*
::第7步:
plink -pw onekes!@# -ssh root@121.199.4.73 svn up /opt/download/wow_ios/