...
write_only_game_info(Result,GameType,GameId,CopyId,RoleId,MaxFloor,GetItems,Gold)->
    log:create(games, [GameType,GameId,RoleId,CopyId,Result,MaxFloor,0,Gold, GetItems,datetime:local_time()]).

write_game_info(Result,GameType,GameId,CopyId,RoleId,Score,GetItems,Gold,FinalItem)->
    log:create(games, [GameType,GameId,RoleId,CopyId,Result,Score,FinalItem,Gold, GetItems,datetime:local_time()]).
