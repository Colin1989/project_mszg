...
-record(role_attr_detail, {sculptures=[], equipments=[], life=0, speed=0, atk=0, hit_ratio=0, miss_ratio=0, critical_ratio=0, tenacity=0, battle_power=0}).
-record(role_info_detail, {role_id=0, nickname=[], status=0, level=0, type=0, public=[], battle_prop=#role_attr_detail{}}).
