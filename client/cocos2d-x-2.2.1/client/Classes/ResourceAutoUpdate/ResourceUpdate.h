...
{
public:
	ResourceUpdate(const std::string& downloadDir, unsigned int connectTimeout, unsigned int downloadTimeout, const std::string& versionNativeFile, const std::string& md5NativeFile, ResourceUpdateListener* listener = NULL);
	~ResourceUpdate(void);
