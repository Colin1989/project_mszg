...
//------------------------------------------------------------------------
ResourceUpdate::ResourceUpdate(const std::string& downloadDir, unsigned int connectTimeout, unsigned int downloadTimeout, const std::string& versionNativeFile, const std::string& md5NativeFile, ResourceUpdateListener* listener /*= NULL*/)
: mId(0)
, mMessageList(NULL)
, mUpdatePthread(NULL)
, mRemovePthread(NULL)
