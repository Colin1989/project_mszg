...
EffectShamanCast = class(EffectPlayerCast)
...
--构造
function EffectShamanCast:ctor()
end

function EffectShamanCast:play()
    local roleFile = "shaman_cast.png"
    local roleBgLight = "shaman_cast_light.png"
    local animationid = 30
	...
	effect:setPosition(ccp(360-130, 440+78))
...
--特效持续时间
function EffectShamanCast:duration()
	return 1.5
end
