...
EffectKnightCast = class(EffectPlayerCast)
...
--构造
function EffectKnightCast:ctor()
end

function EffectKnightCast:play()
    local roleFile = "knight_cast.png"
    local roleBgLight = "knight_cast_light.png"
    local animationid = 38
...
--特效持续时间
function EffectKnightCast:duration()
	return 1.0
end
