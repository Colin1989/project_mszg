...
function M.hitPointsMusic(filename)
    sharedEngine:hitPointsBackgroundMusic(filename)
end
...
function M.hitPointsEffect(filename)
    sharedEngine:hitPointsEffect(filename)
end
...
local mt    = {
    ...
    __newindex =  function (t ,k ,v)
        cclog("attemp to update a read-only table")
    end
} 
