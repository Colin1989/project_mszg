package com.onekes.channelconst;
...
import com.onekes.lib.Keys;
import com.onekes.lib.Rsa;
...
public class alipayConst {
	...
	public alipayConst(String result) {
		this.mResult = result;
	}
	...
	static {
		...
		sResultStatus.put("6002", "网络不通畅导致用户中途取消支付操作");
